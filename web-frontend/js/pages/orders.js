...
function buildOrdersUI() {
    ...
    mc.innerHTML =
        ...
        + '<h1 class="orders-title" style="font-size:34px;font-weight:800;margin:0 0 6px;letter-spacing:-.8px;background:linear-gradient(135deg,#fff 30%,#a5b4fc 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">\u6211\u7684\u8ba2\u5355</h1>'
        + '<p class="orders-subtitle" style="font-size:14px;color:rgba(255,255,255,.3);margin:0;">\u6d88\u8d39\u8bb0\u5f55 &middot; \u79ef\u5206\u5145\u5024</p>'
        + '</div>'
        ...
        + '<button class="otab on" id="otab1" onclick="oTab(\'orders\')">&#128203; \u8ba2\u5355\u8bb0\u5f55</button>'
        + '<button class="otab" id="otab2" onclick="oTab(\'recharge\')"><i class="fas fa-coins"></i> \u5145\u5024\u79ef\u5206</button>'
        + '</div>'
